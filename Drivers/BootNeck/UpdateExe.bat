...
set "input_file=.\Application\BootConstDef.h"
...
set "outfile=..\Exe\NeckBoot_%VER%_%SUBVER%_%PAT%_%YR%_%MON%_%DAY%_%VERCODE%.out"
::set "hexfile=..\Exe\NeckBoot_%VER%_%SUBVER%_%PAT%_%YR%_%MON%_%DAY%_%VERCODE%.hex"

::copy .\Flash_Lib\NeckBoot.hex %hexfile%  /y
copy .\Flash_Lib\NeckBoot.out %outfile%  /y
...
::cd /d %~dp0
::rem xcopy .\Flash_Lib\NeckBoot.hex ..\Exe\*.*  /Y
::xcopy .\Flash_Lib\NeckBoot.out ..\Exe\*.*  /Y
::pause