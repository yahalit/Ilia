...
%     end 
    ...
    Bit = struct ('MotorOn',bitget(BitW,1),'MotorReady',bitget(BitW,2),'StoEvent',bitget(BitW,3),'ProfileConverged',bitget(BitW,4),'MotionConverged',bitget(BitW,5),...
        ...
        'Configured',bitget(BitW,29),'Homed',bitget(BitW,30),'SusiMode',bitget(BitW,31),... 
