   ...
   {& ClaControlPars.KpCur,16, 1.0e-6f,1.0e1f,1.0f} ,// !< Kp for current control
   {& ClaControlPars.KiCur,17, 1.0e-6f,3.0e4f,1300.0f} ,// !< Ki for current control
   {& ClaControlPars.VectorSatFac,18, 0.1f,1.0f,0.63f} ,// !< Vector saturation factor
   {& ClaControlPars.KAWUCur,19, 0.0000001f,1.0e6f,1.0f} ,// !< Anti windup for current control
   {& ClaControlPars.VDcMax,20, 0.0000001f,1.0e6f,52.0f} ,// !< Maximum for VDC
   {& ClaControlPars.VDcMin,21, 0.0000001f,1.0e6f,14.0f} ,// !< Minimum for VDC
   ...
   {& ClaControlPars.MinAnalogRef,50, 0.001f,0.98f,0.17f} ,// !< Max change in PU field angle per cycle
   {& ClaControlPars.MaxAnalogRef,51, 0.05f,1.0f,0.85f} ,// !< Max change in PU field angle per cycle
   {& ClaControlPars.MinAnalogTrqCmd,52, 0.001f,10.0f,0.2f} ,// !< Max change in PU field angle per cycle
   {& ClaControlPars.MaxAnalogTrqCmd,53, 0.001f,10.0f,4.0f} ,// !< Max change in PU field angle per cycle
