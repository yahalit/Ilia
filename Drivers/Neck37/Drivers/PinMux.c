...
#undef NGP
#define NGP 28
    GPIO_setPinConfig(GPIO_28_GPIO28) ; // For Hardware 2.0 and on this is a Hall input
    GPIO_setDirectionMode(NGP, GPIO_DIR_MODE_IN);
    GPIO_setPadConfig(NGP, GPIO_PIN_TYPE_STD);
...
#undef NGP
#define NGP 33  // For Hardware 2.0 and on this is a Hall input
...
void SetAdcMux(void)
{
    ...
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER3, ADC_TRIGGER_EPWM2_SOCA,
                  ADC_CH_ADCIN2, ADC_SAMPLE_WINDOW);
...
*/
    ProjId = PROJ_TYPE_TRAY_ROTATOR ; // PROJ_TYPE_TRAY_SHIFTER ; //  ; // PROJ_TYPE_NECK2 ;
}
