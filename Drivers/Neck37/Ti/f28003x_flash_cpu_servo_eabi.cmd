MEMORY
{
   ...
   /* Flash sectors */
   /* BANK 0 */
   FLASH_BANK0_SEC0  : origin = 0x083002, length = 0x001FFE
   FLASH_BANK0_SEC1  : origin = 0x085000, length = 0x001000
   FLASH_BANK0_SEC4AndNext  : origin = 0x086000, length = 0x00a000
