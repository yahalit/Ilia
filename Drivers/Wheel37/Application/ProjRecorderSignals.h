// Flags =  0 : long , 2 float , 4 unsigned , 8 short , 64 dfloat (sim only)  (see more options in the CCmdMode definition)
        ...
        { 2 , (long unsigned *) & SysState.Gyro.Omega[0] }, //:Omega0 [Sensors] {Omega0}
        { 2 , (long unsigned *) & SysState.Gyro.Omega[1] }, //:Omega1 [Sensors] {Omega1}
        { 2 , (long unsigned *) & SysState.Gyro.Omega[2] }, //:Omega2 [Sensors] {Omega2}
