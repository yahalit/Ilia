...
EXTERN_TAG short unsigned FsiTag ;
...
struct CGyro
{
    short unsigned bExists ;
    short State ;
    short StateCnt ;
    short unsigned Read[5] ;
...
//    struct CPVT PVT ;
    ...
    short unsigned PlaceInIntfcTxBuf ;
    short unsigned InDataCnt ;
    short unsigned FirstMessageJunkGot ; // Prevent a forst-run false message acceptance by accidental counter mismatch
    short unsigned AxisSelector ;
    short unsigned ActiveCommunicationAxis ;
    short unsigned bCanTxCounter ;
    short FeedForward ;
#endif
    short unsigned IntfcDisableWheelAutoStop ;
    short unsigned SwState   ;
    short unsigned Algn2 ;
