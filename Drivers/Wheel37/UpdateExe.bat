...
set "outfile=..\Exe\WheelPower_%VER%_%SUBVER%_%PAT%_%YR%_%MON%_%DAY%_%VERCODE%.out"
set "hexfile=..\Exe\WheelPower_%VER%_%SUBVER%_%PAT%_%YR%_%MON%_%DAY%_%VERCODE%.hex"

copy .\Flash_Lib\WheelPower.out %outfile%  /y
copy .\Flash_Lib\WheelPower.hex %hexfile%  /y
