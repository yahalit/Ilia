...
// End generic defaults
    ...
    // If you add new project: Dont forget to update also ProjSpecificCtl[Proj]
        ...
        const struct CProjSpecificData ProjSpecificData[] =
        {
         {.ProjIndex = 0 ,// PROJ_UNDEFINED
          ...
          {.ProjIndex = 1 ,// PROJ_TYPE_WHEEL_R
           .ProjSpecificDataRevision = HwConfigRevision,
              .FullAdcRangeCurrent = FULL_ADC_RANGE_WH_CURRENT_R2 , .EncoderCountsFullRev = 65536 ,  .Rev2Pos = 0.0488f , .HallAngleOffset = 0 , .nPolePairs=5, .InvertEncoder=1 ,
         ...
         {.ProjIndex = 2 ,// PROJ_TYPE_STEERING_R
          .ProjSpecificDataRevision = HwConfigRevision,
              .FullAdcRangeCurrent = STEERING_CUR_ADC_RANGE , .EncoderCountsFullRev = 65536 ,  .Rev2Pos = 0.005623513287261f , .HallAngleOffset = 0.044214f , .nPolePairs=2, .InvertEncoder=1 ,
        ...
        {.ProjIndex = 8 , // PROJ_TYPE_TRAY_ROTATOR
         .ProjSpecificDataRevision = HwConfigRevision,
             .FullAdcRangeCurrent = FULL_ADC_RANGE_CURRENT_NECK , .EncoderCountsFullRev = 4000 ,  .Rev2Pos = 0.012699312656001f,  .HallAngleOffset = 0 , .nPolePairs=4, .InvertEncoder=0 ,
         ...
         {.ProjIndex = 9 , // PROJ_TYPE_TRAY_SHIFTER
          .ProjSpecificDataRevision = HwConfigRevision,
              .FullAdcRangeCurrent = FULL_ADC_RANGE_CURRENT_NECK , .EncoderCountsFullRev = 8000 ,  .Rev2Pos = 0.0095484f ,  .HallAngleOffset = 0 , .nPolePairs=4, .InvertEncoder=1 ,
