...
set "outfile=..\Exe\WheelInterface_%VER%_%SUBVER%_%PAT%_%YR%_%MON%_%DAY%_%VERCODE%.out"
set "hexfile=..\Exe\WheelInterface_%VER%_%SUBVER%_%PAT%_%YR%_%MON%_%DAY%_%VERCODE%.hex"

copy .\CPU1_FLASH\WheelInterface.out %outfile%  /y
copy .\CPU1_FLASH\WheelInterface.hex %hexfile%  /y
::xcopy .\Flash_Lib\WheelPower.hex ..\Exe\*.*  /Y
