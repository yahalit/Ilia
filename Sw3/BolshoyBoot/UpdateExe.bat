...
set "input_file=.\CcsPrj\Application\BootConstDef.h"
...
set "outfile=..\Exe\BolshoyBootR3_%VER%_%SUBVER%_%PAT%_%YR%_%MON%_%DAY%_%VERCODE%.out"
::set "hexfile=..\Exe\BolshoyBootR3_%VER%_%SUBVER%_%PAT%_%YR%_%MON%_%DAY%_%VERCODE%.hex"

echo %outfile%
::copy .\CPU1\DebugDsp\BolshoyBootR3.hex %hexfile%  /y
copy .\CcsPrj\CPU1\DebugDsp\BolshoyBootR3.out %outfile%  /y
