...
#ifndef APPLICATION_BOOTCONSTDEF2_H_
#define APPLICATION_BOOTCONSTDEF2_H_
...
//#define BOOT_VER (( (long)BOOT_YR << 20 ) + ((long)BOOT_MONTH<<16) + ((long)BOOT_DAY <<8) + (long) BOOT_SUBVER ) ;
...
#endif /* APPLICATION_BOOTCONSTDEF2_H_ */
