...
void InitGpio(void)
{
    ...
    GPIO_SetupPinOptions(61, GPIO_INPUT, GPIO_SYNC);
    ...
    // GPIO81 and 82 are spare actuator inputs
    GPIO_SetupPinMux(81, GPIO_MUX_CPU1, 0);
    GPIO_SetupPinOptions(81, GPIO_INPUT, GPIO_SYNC);
    GPIO_SetupPinMux(82, GPIO_MUX_CPU1, 0);
    GPIO_SetupPinOptions(82, GPIO_INPUT, GPIO_SYNC);
