...
set "input_file=.\Application\BootConstDef2.h"
...
set "outfile=..\Exe\BolshoyBoot2R3_%VER%_%SUBVER%_%PAT%_%YR%_%MON%_%DAY%_%VERCODE%.out"
::set "hexfile=..\Exe\BolshoyBoot2R3_%VER%_%SUBVER%_%PAT%_%YR%_%MON%_%DAY%_%VERCODE%.hex"

echo %outfile%
::copy .\CPU2\DebugDsp\BolshoyBoot2R3.hex %hexfile%  /y
copy .\CPU2\DebugDsp\BolshoyBoot2R3.out %outfile%  /y
