...
#define ADC_TRIGGER (0x7L<<20) // PWM2 SOCA

    AdcaRegs.ADCSOC0CTL.all = (2L << 15) + AcClocks + ADC_TRIGGER;
    AdcaRegs.ADCSOC1CTL.all = (3L << 15) + AcClocks + ADC_TRIGGER;
    AdcaRegs.ADCSOC2CTL.all = (4L << 15) + AcClocks + ADC_TRIGGER;
    AdcaRegs.ADCSOC3CTL.all = (5L << 15) + AcClocks + ADC_TRIGGER;

    AdcbRegs.ADCSOC0CTL.all = (0L << 15) + AcClocks + ADC_TRIGGER;
    AdcbRegs.ADCSOC1CTL.all = (1L << 15) + AcClocks + ADC_TRIGGER;
    AdcbRegs.ADCSOC2CTL.all = (2L << 15) + AcClocks + ADC_TRIGGER;
    AdcbRegs.ADCSOC3CTL.all = (3L << 15) + AcClocks + ADC_TRIGGER;
    AdcbRegs.ADCSOC4CTL.all = (4L << 15) + AcClocks + ADC_TRIGGER;
    AdcbRegs.ADCSOC5CTL.all = (5L << 15) + AcClocks + ADC_TRIGGER;

    AdccRegs.ADCSOC0CTL.all = (2L << 15) + AcClocks + ADC_TRIGGER;
    AdccRegs.ADCSOC1CTL.all = (3L << 15) + AcClocks + ADC_TRIGGER;
    AdccRegs.ADCSOC2CTL.all = (4L << 15) + AcClocks + ADC_TRIGGER;
    AdccRegs.ADCSOC3CTL.all = (14L << 15) + AcClocks + ADC_TRIGGER;
    AdccRegs.ADCSOC4CTL.all = (15L << 15) + AcClocks + ADC_TRIGGER;

    AdcaRegs.ADCINTSEL1N2.all = 0; //No ints
    AdcaRegs.ADCINTSEL3N4.all = 0; //No ints
    AdcaRegs.ADCINTFLGCLR.all = 0xf; //make sure all flag is cleared

    AdcbRegs.ADCINTSEL1N2.all = 0; //No ints
    AdcbRegs.ADCINTSEL1N2.bit.INT1CONT = 1; //No need to clear int
    AdcbRegs.ADCINTSEL1N2.bit.INT1SEL  = 5 ; // EOC 5 is trigger
    AdcbRegs.ADCINTSEL1N2.bit.INT1E = 1; // Int enable
    AdcbRegs.ADCINTSEL3N4.all = 0; //No ints
    AdcbRegs.ADCINTFLGCLR.all = 0xf; //make sure all flag is cleared

    AdccRegs.ADCINTSEL1N2.all = 0; //No ints
    AdccRegs.ADCINTSEL3N4.all = 0; //No ints
    AdccRegs.ADCINTFLGCLR.all = 0xf; //make sure all flag is cleared
