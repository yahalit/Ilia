...
//extern Uint16 EBSSStart;
//extern Uint16 EBSSEnd;
void  ClearStart2End( Uint16*start , Uint16* end);
...
// symbols are created by the linker. Refer to the device .cmd file.
    ...
    ClearStart2End((Uint16 *)0x00C000,(Uint16 *)0x017000) ;
...
//#endif
    ...
    EALLOW ;
    ClkCfgRegs.LOSPCP.bit.LSPCLKDIV = 2 ; // SPI / UART base frequency will be 50MHz
    ClkCfgRegs.PERCLKDIVSEL.bit.EPWMCLKDIV = 1 ; // PWM frequency will be 100MHz
...
void InitSysPll(Uint16 clock_source, Uint16 imult, Uint16 fmult, Uint16 divsel)
{
    ...
    if(imult != ClkCfgRegs.SYSPLLMULT.bit.IMULT || fmult != ClkCfgRegs.SYSPLLMULT.bit.FMULT)
    {
        ...
        temp_syspllmult = ClkCfgRegs.SYSPLLMULT.all;
...
void InitAuxPll(Uint16 clock_source, Uint16 imult, Uint16 fmult, Uint16 divsel)
{
   ...
   if(ClkCfgRegs.AUXPLLMULT.bit.IMULT != imult || ClkCfgRegs.AUXPLLMULT.bit.FMULT !=fmult)
   {
       ...
       temp_auxpllmult = ClkCfgRegs.AUXPLLMULT.all;
